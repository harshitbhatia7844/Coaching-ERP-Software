    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                href="{{ route('centre.dashboard') }}">
                <div class="sidebar-brand-icon ">
                    {{-- <i class="fas fa-laugh-wink"></i> --}}
                    <img src={{ asset('images/montage.png')}} alt="">
                </div>
                <div class="sidebar-brand-text mx-3">Centre</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('centre.dashboard') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href={{ route('centre.viewstudents') }}>View All Students</a>
                        <a class="collapse-item" href={{ route('centre.createstudent') }}>Register Student</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Course</h6>
                        <a class="collapse-item" href={{ route('centre.notification') }}>All Notification</a>
                        <a class="collapse-item" href={{ route('centre.createnotification') }}>Create Notification</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href={{ route('centre.404') }}>Settings</a>
                        <a class="collapse-item" href={{ route('centre.profile') }}>Porfile</a>
                        {{-- <a class="collapse-item" href={{ route('centre.404') }}>Other</a> --}}
                        <hr>
                        <a class="collapse-item" href={{ route('centre.logout') }}>Logout</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a href="{{route('centre.wallet')}}" class="dropdown-item d-flex align-items-center">
                                    <div class="mr-3">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('centre.profile') }}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href={{ route('centre.logout') }}>Logout</a>
                </div>
            </div>
        </div>
    </div>
